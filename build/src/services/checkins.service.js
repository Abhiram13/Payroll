...
exports.listOfCheckIns = exports.insertCheckIns = void 0;
const checkins_controller_1 = require("../controllers/checkins.controller");
function insertCheckIns(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const controller = new checkins_controller_1.CheckInController();
...
exports.insertCheckIns = insertCheckIns;
function listOfCheckIns(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const controller = new checkins_controller_1.CheckInController();
...
exports.listOfCheckIns = listOfCheckIns;
